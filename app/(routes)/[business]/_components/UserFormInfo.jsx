...
// {setUserName,setUserEmail,setUserNote} -> need to be sent back
const UserFormInfo = ({setUserName,setUserEmail,setUserNote}) => { 
  return (
    <div className='p-4 px-8 flex flex-col gap-3'>
        ...
        <div>
            <h2 className='text-xs text-gray-400'>By Proceeding, you confirm that you have read and agreed the terms and conditions</h2>
        </div>
    </div>
  )
}
